...
def find_center_line_for_missing_one_line(image,left_fit,right_fit):
    ...
    if val > 0:
        ...
        center_x = np.clip(left_fitx+40,image.shape[1]*0.25+1,image.shape[1]-image.shape[1]*0.25-1)
        ...
        center_x = np.clip(right_fitx-40,image.shape[1]*0.25+1,image.shape[1]-image.shape[1]*0.25-1)
