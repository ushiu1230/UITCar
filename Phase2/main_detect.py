...
from signboard_detect import detect_color, detect_sign
...
if __name__ == '__main__':
    ...
    while True:
        ...
        cv2.imshow("fullimg", img_full)
        a, b = detect_sign(img_full)
        state = detect_color(img_full, state)
        print(state)
        #print(detect_color(img_full, x, y, state))
